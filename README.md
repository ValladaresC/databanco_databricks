...
### Nota: se realizó una consulta SQL llamada $${\color{red}Creacion Catalogo Esquemas}$$ donde se creó el catalogo de este proyecto 'catalgbanco' con los diferentes esquemas que representan cada capa (capabronze, capasilver, capagold) con el siguiente código SQL:
...
### 3. Análisis
### Se realizó un Dashboard a partir de la tabla delta de la capa gold trx_resumen, obteniendo los siguientes resultados:
![image](https://github.com/user-attachments/assets/5d9889a0-aa31-48f3-a0be-06cad855525a)
