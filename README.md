...
### Nota: se realizó una consulta SQL llamada $${\color{red}Creacion Catalogo Esquemas}$$ donde se creó el catalogo de este proyecto 'catalgbanco' con los diferentes esquemas que representan cada capa (capabronze, capasilver, capagold).
